...
<div class="main-content">
				...
				<div class="page-content">
					...
					<div class="row-fluid">
						<div class="span12">
							<!--PAGE CONTENT BEGINS-->
							<form action="<%=basePath%>/hao/blog/add" id="addArticleForm" method="post">
							标题<input type="text" class="span6" id="newsTitle" name="newsTitle"/><br/>
							日期<input type="text" class="span2" id="newsDate" name="newsDate" value="${today}"/>
							标签<select class="span2" id="newsTags" name="newsTags" multiple="multiple">
							<c:forEach items="${tags}" var="tag" >
							<option value="${tag.tagName}">${tag.tagName}</option>
							</c:forEach>
							</select>
							来源<input type="text" class="span2" id="source" name="source"/>
							类型<select class="span2" id="newsType" name="newsType"/>
							<option value="1" selected>文章</option>
							<option value="2" >视频</option>
							<option value="3" >相册</option>
							</select><br/>
							视频代码：<textarea class="span10" rows="3" name="videoCode"></textarea><br/>
							内容<textarea class="span12" id="wysiwyg" name="newsContent" rows="20">${news.newsContent}</textarea><br/>
					 		<br>
