...
<meta name="copyright" content="openui.cn" />
<meta name="author" content="openui.cn" />
<style>
...
h2, h3 {margin-bottom:1em; padding:.2em .4em; border-bottom:3px solid #CCF; background:#000; color:#fff}
...
.group input {display:block; margin-top:64px; background:#fff; font-family:"Lucida Console","Lucida Sans Typewriter",Monaco,"Bitstream Vera Sans Mono",monospace; border: none 0; font-size:14px; width:100%; text-align:center}
...
#header h1 span {display:block; font-size:40px}
...
.aside{margin:50px auto 0; width: 728px;}
.morelinks{text-align: center;color: #999;margin: 50px 0;text-decoration: none;}
...
!function(e,n){var a="",i=""
for(var o in COLORTABLE){var t=COLORTABLE[o]
i+="<div class='section by"+o+"'>",i+="<h2>"+t.title+"</h2>",i+="<blockquote>"+t.intro+"</blockquote>",a+="<h4>"+t.title+"</h4>",a+="<div>"
for(var s=0,l=t.table.length;l>s;s++){var r=t.table[s]
i+="<div class='sub-section' id='"+o+"_"+s+"'>",i+="<h3>"+r.name+"</h3>",i+="<blockquote>"+r.desc+"</blockquote>",i+="<div class='groups'>",a+="<a href='#"+o+"_"+s+"'>"+r.name+"</a>"
for(var c=0,d=r.colors.length;d>c;c++){var v=r.colors[c]
i+="<div class='group'><span style='background:"+v[0]+"'><input type='text' value='"+v[0]+"' onmouseover='this.focus();this.select()' /></span><span style='background:"+v[1]+"'><input type='text' value='"+v[1]+"' onmouseover='this.focus();this.select()' /></span><span style='background:"+v[2]+"'><input type='text' value='"+v[2]+"' onmouseover='this.focus();this.select()' /></span></div>"}i+="</div>",i+="</div>"}i+="</div>",a+="</div>"}e.innerHTML=i,n.innerHTML=a}(document.getElementById("main"),document.getElementById("nav"));
</script>
</div>
<div class="aside">
<!-- tool_728x90 -->
